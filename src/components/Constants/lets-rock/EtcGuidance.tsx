    ...
    <section className="px-4 py-6">
      <Paragraph title="기타 안내">
        <ul>
          ...
          <DotText>
            공연장 내에서의 일반적인 수준의 기념 사진 및 영상 촬영은 가능하나 스탠딩존 내에서의 촬영 장비 사용, SNS
            채널을 이용한 생중계, 공연 실황 녹음 등은 진행요원에 의하여 제지 받을 수 있습니다.
            <br /> 또한 적발시 데이터 삭제 요구 및 퇴장 등의 조치를 받을 수 있으니 유의하여 주시기 바랍니다.
          </DotText>
          <DotText>
            공연장 내/외에서 관람객 본인 부주의로 발생하는 사고, 도난, 분실 등은 주최측에서 책임지지 않으니 안전 및
            귀중품 보관에 유의하여 주시기 바랍니다.
          </DotText>
        </ul>
        <br />
        <BodyText>
        ...
        <br />
        <br />
        <BodyText>{`본 프로젝트는 한국콘텐츠진흥원의 '2022 ICT-음악(뮤직테크) 제작 지원 사업'으로 기획・운영됩니다.`}</BodyText>
      </Paragraph>
    </section>
  );
};
