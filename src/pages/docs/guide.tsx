...
const GuidePage = () => {
  return (
    <>
      ...
      <article className="w-full py-8 px-[18px] flex flex-col top-1/2 left-1/2 min-w-[320px] gap-8">
        <header>
        ...
        <section className="whitespace-pre-line">
          ...
          <section>
            ...
            <p className="text-sm leading-4 ">
              <br />
              <BodyText>우선 NFT를 보관할 디지털 자산 지갑이 필요해요.</BodyText>
              <br />
              <br />
              <BodyText>
                Connectable은 현재{' '}
          ...
          <section>
            ...
            <p className="text-sm leading-4 ">
              ...
              <br />
              <br />
              <BodyText>원하는 티켓을 선택하신 후, 예매 폼을 제출해주세요.</BodyText>
              <br />
              <br />
              <BodyText>
              ...
              <br />
              <br />
              <BodyText>2022년 안에, 암호화폐와 카드 결제로 구매가 가능하도록 계획하고 있습니다.</BodyText>
            </p>
          </section>
          <section>
            ...
            <p className="text-sm leading-4 ">
              ...
              <br />
              <br />
              <BodyText>마이페이지에서 {`‘마이 티켓'`}을 확인할 수 있어요.</BodyText>
              <br />
              <br />
              <BodyText>본인의 티켓을 클릭하면 공유하기, 전송하기, QR 입장 기능을 사용할 수 있습니다.</BodyText>
            </p>
          </section>
        </section>
      </article>
