...
const TermOfServicePage = () => {
  return (
    <>
      ...
      <article className="w-full py-8 px-[18px] flex flex-col top-1/2 left-1/2 min-w-[320px] gap-4">
        <header>
        ...
        <section className="whitespace-pre-line">
          ...
          <p className="text-sm leading-6 ">
            ...
            <br />
            <br />
            <BodyText>⑤ {'"컬렉션"'}이란, NFT로 티켓이 발행된 공연 및 이벤트를 뜻합니다.</BodyText>
            <br />
            <br />
            <BodyText>
        ...
        <section className="whitespace-pre-line">
          ...
          <p className="text-sm leading-6 ">
            ...
            <br />
            <br />
            <BodyText>② 회사는 필요한 경우 관련 법령을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.</BodyText>
            <br />
            <br />
            <BodyText>
        ...
        <section className="whitespace-pre-line">
          ...
          <p className="text-sm leading-6 ">
            <br />
            <BodyText>① 회사는 이 약관 외에 별도의 운영정책을 둘 수 있습니다.</BodyText>
            <br />
            <br />
            <BodyText>
        ...
        <section className="whitespace-pre-line">
          ...
          <p className="text-sm leading-6 ">
            <br />
            <BodyText>① 회원은 아래의 행위를 하여서는 안 됩니다.</BodyText>
        ...
        <section className="whitespace-pre-line">
          ...
          <p className="text-sm leading-6 ">
            <br />
            <BodyText>① 당사는 다음과 같은 서비스를 제공합니다.</BodyText>
        ...
        <section className="whitespace-pre-line">
          ...
          <p className="text-sm leading-6 ">
            ...
            <br />
            <br />
            <BodyText>② 회원은 서비스가 정하는 정책, 방법 등에 따라 결제금액을 내야 합니다.</BodyText>
          </p>
          <hr className=" w-full bg-transparent border-b-[1px] border-slate-200 my-2" />
        </section>
        <section className="whitespace-pre-line">
          ...
          <p className="text-sm leading-6 ">
            <br />
            <BodyText>① 회원이 과오납한 금액이 발생한 경우 환불이 이루어집니다.</BodyText>
            <br />
            <br />
            <BodyText>
        ...
        <section className="whitespace-pre-line">
          ...
          <p className="text-sm leading-6 ">
            <br />
            <BodyText>① 회사와 회원간 발생한 분쟁에 대하여는 대한민국 법을 준거법으로 합니다.</BodyText>
            <br />
            <br />
            <BodyText>
